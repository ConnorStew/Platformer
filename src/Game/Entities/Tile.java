...
public class Tile {
	...
	/**
	 * Creates a new tile.
	 * @param tileImage the image to use for the tile
	 * @param tileWidth the width of the tile
	 * @param tileHeight the height of the tile
	 * @param x the starting x coordinate of the tile
	 * @param y the starting y coordinate of the tile
	 */
	public Tile(Image tileImage, float tileWidth, float tileHeight, int x, int y) {
		...
		//lines used to calculate slime line of sight
